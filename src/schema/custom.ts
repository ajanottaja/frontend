...
export const tsRangeToObject = z
  .object({
...
export const tsRangeObjectToString = z
  .object({
    ...
    lowerInclusive: z.boolean().optional().default(true).transform(v => v ? "[" : "("),
    upperInclusive: z.boolean().optional().default(false).transform(v => v ? "]" : ")"),
  })
  .transform(v => {
