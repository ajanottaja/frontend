    ...
    <Transition show={isOpen} as={Fragment} appear>
      <Dialog as="div" className="relative z-10" open={isOpen} onClose={onClose}>
        ...
        <div className="fixed inset-0 flex flex-col justify-center items-center p-4 sm:p-6">
          ...
          >
            <DialogPanel className="flex flex-col w-full max-w-md bg-stone-900/50 backdrop-blur-sm border border-stone-700/30 rounded-xl shadow-xl transform transition-all overflow-y-visible">
